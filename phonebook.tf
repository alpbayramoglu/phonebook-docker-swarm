...
locals {
  github-repo = "https://github.com/alpbayramoglu/phonebook-docker-swarm.git"
  github-file-url = "https://raw.githubusercontent.com/alpbayramoglu/phonebook-docker-swarm/master/"
}
